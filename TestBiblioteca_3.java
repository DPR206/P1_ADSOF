 ...
 * @version 1.1
 * Nombre del fichero: TestBiblioteca_3.java
 */
public class TestBiblioteca_3 {

	/**
	 * Punto de entrada de la aplicación
	 * El programa prueba a filtrar los libros por año y género inexistente
	 * 
	...
	public static void main(String[] args) {
		...
		libros_año = biblio.librosPosterioresA(2020);
		for(Libro l: libros_año)
			System.out.println(l);
		
		List<Libro> libros_genero = new ArrayList<> ();
		libros_genero = biblio.librosPorGenero("Ciencia ficción");
